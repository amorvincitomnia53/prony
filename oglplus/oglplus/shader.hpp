...
#endif
#if OGLPLUS_DOCUMENTATION_ONLY || GL_ES_VERSION_3_0 || GL_VERSION_4_1 || GL_ARB_ES2_compatibility
...
public:
    ...
    Shader(
        ShaderType type,
        GLSLString&& glsl_source) : Object<ShaderOps>(type)
    {
    ...
    Shader(
        ...
        GLSLString&& glsl_source) : Object<ShaderOps>(type, std::move(description))
    {
        this->Source(std::move(glsl_source));
        this->Compile();
    }
    ...
    Shader(
        ShaderType type,
        GLSLStrings&& glsl_source) : Object<ShaderOps>(type)
    {
        this->Source(std::move(glsl_source));
        this->Compile();
    }
    ...
    Shader(
        ShaderType type,
        ObjectDesc&& description,
        GLSLStrings&& glsl_source) : Object<ShaderOps>(type, std::move(description))
    {
        this->Source(std::move(glsl_source));
        this->Compile();
    }
    ...
    Shader(
        ShaderType type,
        const GLSLSource& glsl_source) : Object<ShaderOps>(type)
    {
    ...
    Shader(
        ShaderType type,
        ObjectDesc&& description,
        const GLSLSource& glsl_source) : Object<ShaderOps>(type, std::move(description))
    {
        this->Source(glsl_source);
        this->Compile();
    }
...
public:
    ...
    SpecShader(
        ObjectDesc&& description,
        GLSLString&& glsl_source) : Shader(ShType, std::move(description), std::move(glsl_source))
    {
    }
    ...
    SpecShader(
        ObjectDesc&& description,
        GLSLStrings&& glsl_source) : Shader(ShType, std::move(description), std::move(glsl_source))
    {
    }
    ...
    SpecShader(
        ObjectDesc&& description,
        const GLSLSource& glsl_source) : Shader(ShType, std::move(description), glsl_source)
    {
    }
