...
public:
    ...
    OneOf(
        ...
        typename std::enable_if<
            std::is_convertible<T, V1>::value>::type* = nullptr) : _value(Common(V1(value)))
    {
    }
    ...
    OneOf(
        T value,
        typename std::enable_if<
            std::is_convertible<T, V2>::value>::type* = nullptr) : _value(Common(V2(value)))
    {
    }
...
public:
    ...
    OneOf(
        T value,
        typename std::enable_if<
            std::is_convertible<T, V3>::value>::type* = nullptr) : _value(Common(V3(value)))
    {
    }
...
private:
    ...
    template <typename T, typename V, typename... Vi>
    static auto _find_one_of(void) -> decltype(_do_find_one_of<T, V, Vi...>(std::is_convertible<T, V>()));

    template <typename T, typename V, typename V1, typename... Vi>
    static auto _do_find_one_of(std::false_type) -> decltype(_find_one_of<T, V1, Vi...>());
...
public:
    ...
    OneOf(
        T value,
        typename std::enable_if<is_one_of<T>::value>::type* = nullptr) : _value(aux::OneOfBase<Common, T>::Accept(value))
    {
    }
    ...
    OneOf(
        T value,
        typename std::enable_if<!is_one_of<T>::value>::type* = nullptr) : _value(aux::OneOfBase<Common, typename find<T>::type>::Accept(value))
    {
    }
