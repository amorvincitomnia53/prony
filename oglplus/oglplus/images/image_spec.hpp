...
struct ImageSpecData {
    ...
    ImageSpecData(
        ...
        PixDataType type,
        const void* data) : width(w), height(h), depth(d), format(fmt), internal_format(ifmt), data_type(type), data_ptr(data)
    {
    }
};
...
struct ImageSpec
    ...
    ImageSpec(
        SizeType w,
        SizeType h,
        PixelDataInternalFormat ifmt) : _base(w, h, 1, _conv(ifmt), ifmt, PixelDataType(), nullptr)
    {
    }
    ...
    ImageSpec(
        ...
        SizeType h,
        PixelDataFormat fmt,
        PixDataType type) : _base(w, h, 1, fmt, _conv(fmt), type, nullptr)
    {
    }
    ...
    ImageSpec(
        ...
        PixelDataFormat fmt,
        PixelDataInternalFormat ifmt,
        PixDataType type) : _base(w, 1, 1, fmt, ifmt, type, nullptr)
    {
    }
    ...
    ImageSpec(
        ...
        PixelDataFormat fmt,
        PixelDataInternalFormat ifmt,
        PixDataType type) : _base(w, h, 1, fmt, ifmt, type, nullptr)
    {
    }
    ...
    ImageSpec(
        ...
        PixelDataFormat fmt,
        PixelDataInternalFormat ifmt,
        PixDataType type) : _base(w, h, d, fmt, ifmt, type, nullptr)
    {
    }
    ...
    ImageSpec(
        ...
        typename std::enable_if<
            ...
            const T*>::type
        = nullptr) : _base(w, h, 1, fmt, _conv(fmt), GetDataType<T>(), data)
    {
    }
