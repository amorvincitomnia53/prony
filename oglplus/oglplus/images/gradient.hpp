...
public:
    ...
    LinearGradient(
        SizeType width,
        const Vector<T, N>& background,
        const std::map<P, Vector<T, N>>& x_points) : Image(width, 1, 1, N, &TypeTag<GLubyte>())
    {
    ...
    LinearGradient(
        ...
        Combine combine) : Image(width, height, 1, N, &TypeTag<GLubyte>())
    {
    ...
    LinearGradient(
        ...
        Combine combine) : Image(width, height, depth, N, &TypeTag<GLubyte>())
    {
