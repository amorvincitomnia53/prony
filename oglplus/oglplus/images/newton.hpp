...
public:
    ...
    struct X3Minus1 {
        ...
        {
            return 3.0f * Vec2f(n.x() * n.x() - n.y() * n.y(), 2.0f * n.x() * n.y());
        }
    };
    ...
    struct X4Minus1 {
        ...
        {
            return Vec2f(
                n.x() * n.x() * n.x() * n.x() + n.y() * n.y() * n.y() * n.y() - 6.f * n.x() * n.x() * n.y() * n.y() - 1.f,
                4.f * n.x() * n.x() * n.x() * n.y() - 4.f * n.x() * n.y() * n.y() * n.y());
        }

        static Vec2f df(Vec2f n)
        {
            return 4.0f * Vec2f(n.x() * n.x() * n.x() - 3.f * n.x() * n.y() * n.y(), -n.y() * n.y() * n.y() + 3.f * n.x() * n.x() * n.y());
        }
    };
    ...
    NewtonFractal(
        ...
        Mixer mixer = Mixer()) : Image(width, height, 1, 3, &TypeTag<GLfloat>())
    {
    ...
    NewtonFractal(
        ...
        SizeType height,
        Function func = Function(),
        Mixer mixer = Mixer()) : Image(width, height, 1, 1, &TypeTag<GLfloat>())
    {
        _make(
            width, height,
            func,
    ...
    NewtonFractal(
        ...
        Vec2f rt,
        Function func,
        Mixer mixer) : Image(width, height, 1, 3, (GLfloat*)0)
    {
        _make(width, height, func, mixer, lb, rt, c1, c2);
    }
    ...
    NewtonFractal(
        ...
        SizeType height,
        Function func,
        Mixer mixer) : Image(width, height, 1, 1, (GLfloat*)0)
    {
        _make(
            width, height,
            func,
