...
struct BitmapGlyphRenderingConfig {
    ...
    BitmapGlyphRenderingConfig(void)
        : page_frames(8), plane_count(3), pages_per_plane(256), glyphs_per_page(256), layout_storage_page(1024), layout_storage_unit(4)
    {
    }
};
...
protected:
    ...
    BitmapGlyphRenderingBase(
        ...
        const BitmapGlyphRenderingConfig& config) : _bitmap_tex_unit(bitmap_tex_unit), _metric_tex_unit(metric_tex_unit), _pg_map_tex_unit(pg_map_tex_unit), _config(config)
    {
    }
...
public:
    ...
    BitmapGlyphRenderingBase(BitmapGlyphRenderingBase&& tmp)
        : _bitmap_tex_unit(std::move(tmp._bitmap_tex_unit)), _metric_tex_unit(std::move(tmp._metric_tex_unit)), _pg_map_tex_unit(std::move(tmp._pg_map_tex_unit)), _config(std::move(tmp._config)), _layout_storage(std::move(tmp._layout_storage))
    {
    }
#endif
...
public:
    BitmapGlyphRenderingTpl(
        ...
        TextureUnitSelector metric_tex_unit,
        TextureUnitSelector pg_map_tex_unit,
        const Config& config = Config()) : BitmapGlyphRenderingBase(bitmap_tex_unit,
                                               metric_tex_unit,
                                               pg_map_tex_unit,
                                               config)
    {
