...
private:
    ...
    public:
        ...
        Rectangle GlyphLogicalMetrics(
            CodePoint code_point) OGLPLUS_OVERRIDE
        {
        ...
        GLfloat QueryXOffsets(
            const CodePoint* cps,
            GLsizei size,
            std::vector<GLfloat>& x_offsets) OGLPLUS_OVERRIDE
        {
...
private:
    ...
    public:
        ...
        void Set(
            const CodePoint* code_points,
            const GLsizei length) OGLPLUS_OVERRIDE
        {
...
private:
    ...
    public:
        ...
        AnyLayout MakeLayout(
            const AnyFont& font,
            GLsizei capacity) OGLPLUS_OVERRIDE
        {
            return AnyLayout(
                _ru.MakeLayout(
                    font.As<Font>(),
