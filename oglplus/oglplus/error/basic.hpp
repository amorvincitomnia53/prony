...
public:
    ...
    Error(const Error& that)
        : std::runtime_error(that), _code(that._code)
#if !OGLPLUS_ERROR_NO_FILE
          ,
          _file(that._file)
#endif
...
#if !OGLPLUS_ERROR_NO_GL_SYMBOL
          ,
          _enumpar_name(that._enumpar_name), _enumpar(that._enumpar), _index(that._index)
#endif
    {
    }
#else
...
#define OGLPLUS_HANDLE_ERROR_IF(                                \
    ...
    MESSAGE,                                                    \
    ERROR,                                                      \
    ERROR_INFO) OGLPLUS_HANDLE_ERROR_WITH_HANDLER_IF(CONDITION, \
    ERROR_CODE,                                                 \
    MESSAGE,                                                    \
    ERROR,                                                      \
    ERROR_INFO,                                                 \
...
#define OGLPLUS_GLFUNC_CHECK_WITH_HANDLER(                                         \
    ...
    ERROR,                                                                         \
    ERROR_INFO,                                                                    \
    HANDLER_MACRO) OGLPLUS_HANDLE_ERROR_WITH_HANDLER_IF(error_code != GL_NO_ERROR, \
    glGetError(),                                                                  \
