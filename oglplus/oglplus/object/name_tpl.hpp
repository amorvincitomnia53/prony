...
protected:
    inline NameT _obj_name(void) const
        OGLPLUS_NOEXCEPT(true)
    {
        return _name;
    }

    inline NameT* _name_ptr(void)
        OGLPLUS_NOEXCEPT(true)
    {
        return &_name;
    }

    inline const NameT* _name_ptr(void) const
        OGLPLUS_NOEXCEPT(true)
    {
        return &_name;
    }

    static inline NameT _invalid_name(void)
        OGLPLUS_NOEXCEPT(true)
    {
        return ~NameT(0);
    }

    inline bool _has_deletable_name(void)
        OGLPLUS_NOEXCEPT(true)
    {
...
public:
    static ObjectName InvalidName(void)
        OGLPLUS_NOEXCEPT(true)
    {
