...
public:
    ...
    TwistedTorus(void)
        : _radius_out(1.0), _radius_in(0.5), _thickness(0.02), _s_slip_coef(0.20), _sections(12), _rings(48), _twist(12)
    {
    }
    ...
    TwistedTorus(
        ...
        unsigned sects,
        unsigned rings,
        unsigned twist) : _radius_out(rad_out), _radius_in(rad_in), _thickness(thickness), _s_slip_coef(0.20), _sections(sects), _rings(rings), _twist(twist)
    {
