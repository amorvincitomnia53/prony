...
public:
    ...
    RevolveY(
        ...
        const std::vector<Vector<Type, 3>>& tex_coords) : _sections(_make_default_sections(sections)), _section_factors(_sections.size(), Type(0)), _rings(positions.size()), _positions_0(positions), _positions_1(_positions_0), _normals_0(_calculate_normals(_positions_0, normals)), _normals_1(_normals_0), _tex_coords_0(tex_coords), _tex_coords_1(_tex_coords_0)
    {
        _check();
        _calc_radius();
    }
    ...
    RevolveY(
        ...
        const std::vector<Vector<Type, 3>>& tex_coords_1) : _sections(_make_default_sections(section_factors.size() - 1)), _section_factors(section_factors), _rings(positions_0.size()), _positions_0(positions_0), _positions_1(positions_1), _normals_0(_calculate_normals(_positions_0, normals_0)), _normals_1(_calculate_normals(_positions_1, normals_1)), _tex_coords_0(tex_coords_0), _tex_coords_1(tex_coords_1)
    {
        _check();
        _calc_radius();
    }
