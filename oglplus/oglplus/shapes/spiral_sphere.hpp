...
public:
    ...
    SpiralSphere(void)
        : _radius(1.0), _thickness(0.1), _bands(4), _divisions(8), _segments(48)
    {
    }
    ...
    SpiralSphere(
        ...
        unsigned bands,
        unsigned divisions,
        unsigned segments) : _radius(radius), _thickness(thickness), _bands(bands), _divisions(divisions), _segments(segments)
    {
    }
