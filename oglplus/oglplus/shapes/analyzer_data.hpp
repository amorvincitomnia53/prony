...
public:
    ...
    static const GLuint _flg_strip_edge = _flg_smooth_edge | _flg_contin_edge | 0x0004;
    static const GLuint _flg_fan_edge = _flg_smooth_edge | _flg_contin_edge | 0x0008;
    ...
    ShapeAnalyzerGraphData(const ShapeBuilder& builder)
        : _instr(builder.Instructions()), _index(_adapt(builder.Indices())), _main_va(), _main_vpv(builder.Positions(_main_va)), _smooth_va(), _smooth_vpv(builder.Normals(_smooth_va)), _eps(1.0e-9)
    {
        _initialize();
    }
