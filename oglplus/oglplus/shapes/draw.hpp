...
private:
    ...
    static std::size_t _do_get_sizeof_index(TypeTag<std::vector<IT>>)
    ...
    static std::size_t _get_sizeof_index(const ShapeBuilder&)
        OGLPLUS_NOEXCEPT(true)
    {
...
public:
    ...
    ElementIndexInfo(const ShapeBuilder& builder)
        : _sizeof_index(_get_sizeof_index(builder)), _index_data_type(_get_index_data_type(builder))
    {
    }
