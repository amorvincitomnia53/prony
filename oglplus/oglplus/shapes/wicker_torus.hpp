...
public:
    ...
    WickerTorus(void)
        : _radius_out(1.0), _radius_in(0.5), _thickness(0.005), _r_slip_coef(0.25), _s_slip_coef(0.40), _sections(24), _rings(24)
    {
    }
    ...
    WickerTorus(
        ...
        double thickness,
        unsigned sects,
        unsigned rings) : _radius_out(rad_out), _radius_in(rad_in), _thickness(thickness), _r_slip_coef(0.25), _s_slip_coef(0.40), _sections(sects), _rings(rings)
    {
