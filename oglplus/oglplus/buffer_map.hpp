...
public:
    ...
    BufferRawMap(
        ...
        Bitfield<BufferMapAccess> access) : _offset(GLintptr(byte_offset.Get())), _size(GLsizeiptr(size_bytes.Get())), _ptr(OGLPLUS_GLFUNC(MapBufferRange)(GLenum(target),
                                                                                                                           _offset,
                                                                                                                           _size,
                                                                                                                           GLbitfield(access))),
                                            _target(target)
    ...
    BufferRawMap(BufferTarget target, Bitfield<BufferMapAccess> access)
        : _offset(0), _size(_get_size(target)), _ptr(
...
public:
    ...
    BufferRawMap(BufferRawMap&& temp)
        : _offset(temp._offset), _size(temp._size), _ptr(temp._ptr), _target(temp._target)
    {
        temp._ptr = nullptr;
    }
...
public:
    ...
    BufferTypedMap(
        ...
        Bitfield<BufferMapAccess> access) : BufferRawMap(target, offset, size, access)
    {
    }
