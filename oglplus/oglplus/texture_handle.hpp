...
public:
    ...
    {
        OGLPLUS_GLFUNC(MakeTextureHandleResidentARB)
        (_handle);
    ...
    {
        OGLPLUS_GLFUNC(MakeTextureHandleNonResidentARB)
        (_handle);
...
public:
    ...
    ImageHandle(
        ...
        Boolean layered,
        GLint layer,
        ImageUnitFormat format) : _handle(OGLPLUS_GLFUNC(GetImageHandleARB)(GetGLName(texture),
                                      level,
                                      layered._v,
                                      layer,
                                      GLenum(format)))
    ...
    void MakeNonResident(void)
    {
        OGLPLUS_GLFUNC(MakeImageHandleNonResidentARB)
        (_handle);
