...
public:
    ...
    DSABufferRawMap(
        ...
        BufferSize offset,
        BufferSize size,
        Bitfield<BufferMapAccess> access) : _offset(GLintptr(offset.Get())), _size(GLsizeiptr(size.Get())), _ptr(OGLPLUS_GLFUNC(MapNamedBufferRange)(GetGLName(buffer),
                                                                                                                _offset,
                                                                                                                _size,
                                                                                                                GLbitfield(access))),
    ...
    DSABufferRawMap(
        BufferName buffer,
        Bitfield<BufferMapAccess> access) : _offset(0), _size(_get_size(GetGLName(buffer))), _ptr(OGLPLUS_GLFUNC(MapNamedBuffer)(GetGLName(buffer),
...
public:
    ...
    {
        if (_ptr != nullptr) {
            OGLPLUS_GLFUNC(UnmapNamedBuffer)
            (_buf_name);
...
public:
    ...
    DSABufferTypedMap(
        ...
        Bitfield<BufferMapAccess> access) : DSABufferRawMap(buffer, offset, size, access)
    {
    }
    ...
    DSABufferTypedMap(
        BufferName buffer,
        Bitfield<BufferMapAccess> access) : DSABufferRawMap(buffer, access)
    {
    }
