...
public:
    ...
    DSAVertexArrayAttrib(
        VertexArrayName vao,
        VertexAttribSlot location) : ProgVarCommonOps<tag::VertexAttrib>(VertexAttribLoc(GLint(location))), _vao(GetGLName(vao))
    {
    }
    ...
    DSAVertexArrayAttrib(
        VertexArrayName vao,
        ProgramName program,
        StrCRef identifier) : ProgVarCommonOps<tag::VertexAttrib>(VertexAttribLoc(program, identifier)), _vao(GetGLName(vao))
    {
    }
