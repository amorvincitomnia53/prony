...
public:
    ...
    DSABufferRawMapEXT(
        ...
        BufferSize offset,
        BufferSize size,
        Bitfield<BufferMapAccess> access) : _offset(GLintptr(offset.Get())), _size(GLsizeiptr(size.Get())), _ptr(OGLPLUS_GLFUNC(MapNamedBufferRangeEXT)(GetGLName(buffer),
                                                                                                                _offset,
                                                                                                                _size,
                                                                                                                GLbitfield(access))),
    ...
    DSABufferRawMapEXT(
        BufferName buffer,
        Bitfield<BufferMapAccess> access) : _offset(0), _size(_get_size(GetGLName(buffer))), _ptr(OGLPLUS_GLFUNC(MapNamedBufferEXT)(GetGLName(buffer),
...
public:
    ...
    DSABufferRawMapEXT(DSABufferRawMapEXT&& temp)
        : _offset(temp._offset), _size(temp._size), _ptr(temp._ptr), _buf_name(temp._buf_name)
    {
        temp._ptr = nullptr;
    }
    ...
    {
        if (_ptr != nullptr) {
            OGLPLUS_GLFUNC(UnmapNamedBufferEXT)
            (_buf_name);
...
public:
    ...
    DSABufferTypedMapEXT(
        ...
        Bitfield<BufferMapAccess> access) : DSABufferRawMapEXT(buffer, offset, size, access)
    {
    }
    ...
    DSABufferTypedMapEXT(
        BufferName buffer,
        Bitfield<BufferMapAccess> access) : DSABufferRawMapEXT(buffer, access)
    {
    }
