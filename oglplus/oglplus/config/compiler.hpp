...
#if defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES) || defined(BOOST_NO_VARIADIC_TEMPLATES) || defined(_MSC_VER)
...
#if defined(BOOST_NO_CXX11_INITIALIZER_LISTS) || defined(BOOST_NO_INITIALIZER_LISTS)
...
#if defined(BOOST_NO_CXX11_DEFAULTED_FUNCTIONS) || defined(BOOST_NO_DEFAULTED_FUNCTIONS) || defined(_MSC_VER)
 ...
 */
#if defined(BOOST_NO_CXX11_USER_DEFINED_LITERALS) || defined(BOOST_NO_USER_DEFINED_LITERALS)
 ...
 * Update this if/when it is implemented
 */
#if defined(BOOST_NO_CXX11_INHERITED_CONSTRUCTORS) || defined(BOOST_NO_INHERITED_CONSTRUCTORS) || defined(_MSC_VER)
