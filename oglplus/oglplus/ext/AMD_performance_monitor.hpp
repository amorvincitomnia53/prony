...
protected:
    static void Gen(tag::Generate, GLsizei count, GLuint* names)
    {
        ...
        OGLPLUS_GLFUNC(GenPerfMonitorsAMD)
        (count, names);
    ...
    {
        assert(names != nullptr);
        OGLPLUS_GLFUNC(DeletePerfMonitorsAMD)
        (count, names);
...
public:
    ...
    {
        OGLPLUS_GLFUNC(BeginPerfMonitorAMD)
        (this->_obj_name());
        OGLPLUS_CHECK(
            BeginPerfMonitorAMD,
            ObjectError,
    ...
    void End(void) const
    {
        OGLPLUS_GLFUNC(EndPerfMonitorAMD)
        (this->_obj_name());
        OGLPLUS_CHECK(
            EndPerfMonitorAMD,
            ObjectError,
