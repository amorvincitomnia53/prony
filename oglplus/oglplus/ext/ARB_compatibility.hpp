...
public:
    ...
    {
        OGLPLUS_GLFUNC(PushAttrib)
        (GLbitfield(attr_groups));
    ...
    {
        OGLPLUS_GLFUNC(LoadMatrixf)
        (Data(Transposed(matrix)));
...
private:
    ...
    {
        OGLPLUS_GLFUNC(MultiTexCoord1i)
        (tex_unit, s);
    }

    static void MultiTexCoord_(GLenum tex_unit, GLint s, GLint t)
    {
        OGLPLUS_GLFUNC(MultiTexCoord2i)
        (tex_unit, s, t);
    }
    ...
    static void MultiTexCoord_(
        ...
        GLint r)
    {
        OGLPLUS_GLFUNC(MultiTexCoord3i)
        (tex_unit, s, t, r);
    }
    ...
    static void MultiTexCoord_(
        ...
        GLfloat r)
    {
        OGLPLUS_GLFUNC(MultiTexCoord3f)
        (tex_unit, s, t, r);
    }
    ...
    static void MultiTexCoord_(
        ...
        GLdouble r)
    {
        OGLPLUS_GLFUNC(MultiTexCoord3d)
        (tex_unit, s, t, r);
    }
    ...
    static void MultiTexCoord_(
        ...
        GLdouble q)
    {
        OGLPLUS_GLFUNC(MultiTexCoord4d)
        (tex_unit, s, t, r, q);
    }
...
private:
    ...
    {
        OGLPLUS_GLFUNC(FogCoordf)
        (c);
    }

    static void FogCoord_(GLdouble c)
    {
        OGLPLUS_GLFUNC(FogCoordd)
        (c);
    }
...
private:
    ...
    {
        OGLPLUS_GLFUNC(Indexi)
        (i);
    }

    static void Index_(GLfloat i)
    {
        OGLPLUS_GLFUNC(Indexf)
        (i);
    }

    static void Index_(GLdouble i)
    {
        OGLPLUS_GLFUNC(Indexd)
        (i);
    }
