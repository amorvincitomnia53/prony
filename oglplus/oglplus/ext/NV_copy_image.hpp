...
private:
    ...
    {
        static_assert(
            std::is_same<SrcObjTag, tag::Texture>() || std::is_same<SrcObjTag, tag::Renderbuffer>(),
            "Source object must be a Texture or a Renderbuffer");
        static_assert(
            std::is_same<DstObjTag, tag::Texture>() || std::is_same<DstObjTag, tag::Renderbuffer>(),
...
public:
        ...
        SizeType width, SizeType height, SizeType depth)
    {
        ...
        OGLPLUS_CHECK(
            CopyImageSubDataNV,
            ObjectPairError,
            Subject(dst_name).SubjectBinding(dst_target).Object(src_name).ObjectBinding(src_target));
    }
        ...
        SizeType width, SizeType height, SizeType depth)
    {
        ...
        OGLPLUS_HANDLE_ERROR_IF(
            ...
            ObjectPairError,
            Subject(dst_name).SubjectBinding(dst_target).Object(src_name).ObjectBinding(src_target).GLLib_glX().GLFunc("CopyImageSubData"));
    }
        ...
        SizeType width, SizeType height, SizeType depth)
    {
        ...
        OGLPLUS_HANDLE_ERROR_IF(
            ...
            ObjectPairError::Message(error_code),
            ObjectPairError,
            Subject(dst_name).SubjectBinding(dst_target).Object(src_name).ObjectBinding(src_target).GLLib_wgl().GLFunc("CopyImageSubData"));
    }
