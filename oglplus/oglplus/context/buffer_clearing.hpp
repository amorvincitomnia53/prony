...
public:
    ...
    static oglplus::context::RGBAValue ColorClearValue(void)
    {
        ...
        (GL_COLOR_CLEAR_VALUE, result._v);
...
public:
        ...
        const GLint* value)
    {
        ...
        OGLPLUS_CHECK(
            ClearBufferiv,
            Error,
            EnumParam(buffer).Index(draw_buffer));
    }
