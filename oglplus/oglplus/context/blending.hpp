...
struct BlendEquationSeparate {
    ...
    friend bool operator==(
        ...
        const BlendEquationSeparate& b) OGLPLUS_NOEXCEPT(true)
    {
...
struct BlendFunctionSeparate {
    ...
    friend bool operator==(
        ...
        const BlendFunctionSeparate& b) OGLPLUS_NOEXCEPT(true)
    {
...
public:
    ...
    static oglplus::BlendEquation BlendEquationAlpha(void)
    {
        GLint result;
        OGLPLUS_GLFUNC(GetIntegerv)
        (GL_BLEND_EQUATION_ALPHA, &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
        return oglplus::BlendEquation(GLenum(result));
    }
    ...
    static void BlendEquation(
        ...
        OneOf<
            ...
            eq)
    {
        OGLPLUS_GLFUNC(BlendEquationi)
        (GLuint(buffer), GLenum(eq));
        OGLPLUS_VERIFY(
            BlendEquationi,
            Error,
            Index(GLuint(buffer)));
