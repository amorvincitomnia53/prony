...
public:
    ...
    {
        OGLPLUS_GLFUNC(Enable)
        (GLenum(functionality) + number);
        OGLPLUS_VERIFY(
            Enable,
            Error,
            EnumParam(functionality).Index(number));
    }
    ...
    {
        OGLPLUS_GLFUNC(Enablei)
        (GLenum(capability), index);
        OGLPLUS_VERIFY(
            Enablei,
            Error,
            EnumParam(capability).Index(index));
    }
