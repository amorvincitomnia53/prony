...
struct StencilFuncArgs {
    ...
    StencilFuncArgs(
        ...
        GLint refv = GLint(0),
        GLuint mask = ~GLuint(0)) OGLPLUS_NOEXCEPT(true)
        : _func(GLenum(func)), _refv(refv), _mask(mask)
    {
    }
    ...
    friend bool operator==(const StencilFuncArgs& a, const StencilFuncArgs& b)
        OGLPLUS_NOEXCEPT(true)
    {
        return (a._func == b._func) && (a._refv == b._refv) && (a._mask == b._mask);
    }
...
struct StencilOperations {
    ...
    StencilOperations(
        ...
        StencilOperation dpass) OGLPLUS_NOEXCEPT(true)
        : _sfail(sfail), _dfail(dfail), _dpass(dpass)
    {
    }
    ...
    friend bool operator==(const StencilOperations& a, const StencilOperations& b)
        OGLPLUS_NOEXCEPT(true)
    {
        return (a._sfail == b._sfail) && (a._dfail == b._dfail) && (a._dpass == b._dpass);
    }
...
public:
    ...
    static CompareFunction StencilFunc(bool backface = false)
    {
        ...
        (
            backface ? GL_STENCIL_BACK_FUNC : GL_STENCIL_FUNC,
            &result);
    ...
    static GLint StencilRef(bool backface = false)
    {
        ...
        OGLPLUS_GLFUNC(GetIntegerv)
        (
            backface ? GL_STENCIL_BACK_REF : GL_STENCIL_REF,
            &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
        return result;
    }
    ...
    static oglplus::context::StencilFuncArgs StencilFuncArgs(bool backface = false)
    {
    ...
    static oglplus::context::StencilFuncArgs StencilFuncArgsSingle(SingleFace face)
    {
    ...
    static StencilOperation StencilFail(bool backface = false)
    {
        ...
        OGLPLUS_GLFUNC(GetIntegerv)
        (
            backface ? GL_STENCIL_BACK_FAIL : GL_STENCIL_FAIL,
            &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
    ...
    static StencilOperation StencilPassDepthFail(bool backface = false)
    {
        ...
        OGLPLUS_GLFUNC(GetIntegerv)
        (
            backface ? GL_STENCIL_BACK_PASS_DEPTH_FAIL : GL_STENCIL_PASS_DEPTH_FAIL,
            &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
        return StencilOperation(result);
    }
    ...
    static StencilOperation StencilPassDepthPass(bool backface = false)
    {
        ...
        OGLPLUS_GLFUNC(GetIntegerv)
        (
            backface ? GL_STENCIL_BACK_PASS_DEPTH_PASS : GL_STENCIL_PASS_DEPTH_PASS,
            &result);
        OGLPLUS_VERIFY_SIMPLE(GetIntegerv);
        return StencilOperation(result);
    }
