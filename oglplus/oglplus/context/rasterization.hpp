...
struct PolygonModes {
    ...
    friend bool operator==(const PolygonModes& a, const PolygonModes& b)
        OGLPLUS_NOEXCEPT(true)
    {
...
struct PolygonOffsPara {
    ...
    friend bool operator==(const PolygonOffsPara& a, const PolygonOffsPara& b)
        OGLPLUS_NOEXCEPT(true)
    {
...
public:
    ...
    static GLfloat PolygonOffsetFactor(void)
    {
        ...
        (GL_POLYGON_OFFSET_FACTOR, &result);
    ...
    static GLfloat PolygonOffsetUnits(void)
    {
        GLfloat result;
        OGLPLUS_GLFUNC(GetFloatv)
        (GL_POLYGON_OFFSET_UNITS, &result);
        OGLPLUS_VERIFY_SIMPLE(GetFloatv);
        return result;
    }
    ...
    static GLfloat PointFadeThresholdSize(void)
    {
        GLfloat result;
        OGLPLUS_GLFUNC(GetFloatv)
        (GL_POINT_FADE_THRESHOLD_SIZE, &result);
        OGLPLUS_VERIFY_SIMPLE(GetFloatv);
        return result;
    }
#endif  // GL_VERSION_3_0
    ...
    {
        OGLPLUS_GLFUNC(ProvokingVertex)
        (GLenum(mode));
    ...
    static GLfloat MinSampleShading(void)
    {
        GLfloat result;
        OGLPLUS_GLFUNC(GetFloatv)
        (GL_MIN_SAMPLE_SHADING_VALUE, &result);
        OGLPLUS_VERIFY_SIMPLE(GetFloatv);
        return result;
    }
    ...
    {
        OGLPLUS_GLFUNC(MinSampleShading)
        (value);
    ...
    {
        OGLPLUS_GLFUNC(FragmentCoverageColorNV)
        (GLuint(buffer));
