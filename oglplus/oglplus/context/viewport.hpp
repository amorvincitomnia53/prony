...
struct ViewportExtents {
    ...
    friend bool operator==(const ViewportExtents& a, const ViewportExtents& b)
        OGLPLUS_NOEXCEPT(true)
    {
...
public:
    ...
    static void DepthRangeArray(
        ...
        const GLclampd* v)
    {
        OGLPLUS_GLFUNC(DepthRangeArrayv)
        (first, count, v);
