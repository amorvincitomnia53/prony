...
public:
        ...
        TransformFeedbackName xfb)
    {
        ...
        OGLPLUS_VERIFY(
            ...
            ObjectError,
            Object(xfb).EnumParam(primitive));
    }
#endif
        ...
        GLfloat t1)
    {
        ...
        OGLPLUS_CHECK(
            DrawTextureNV,
            ObjectPairError,
            Subject(sampler).Object(texture));
    }
...
public:
    ...
    {
        OGLPLUS_GLFUNC(PrimitiveRestartIndex)
        (index);
        OGLPLUS_CHECK(
    ...
    static void PatchParameter(
        ...
        GLint value)
    {
        OGLPLUS_GLFUNC(PatchParameteri)
