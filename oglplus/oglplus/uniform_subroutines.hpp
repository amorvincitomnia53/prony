...
public:
    ...
    ProgVar(
        ...
        ShaderType stage,
        StrCRef identifier,
        bool active_only) : ProgVarLoc<tag::Subroutine>(stage, program, identifier, active_only)
    {
    }
};
...
public:
    ...
    ProgVar(
        ...
        ShaderType stage,
        StrCRef identifier,
        bool active_only) : ProgVarLoc<tag::SubroutineUniform>(stage,
                                program,
                                identifier,
                                active_only) {}
};
...
private:
        ...
        ShaderType stage)
    {
        ...
        OGLPLUS_VERIFY(
            GetProgramStageiv,
            ObjectError,
            Object(program).EnumParam(stage));
...
public:
    ...
    UniformSubroutines(
        ProgramName program,
        ShaderType stage) : _program(program), _stage(stage)
    {
    }
        ...
        const Subroutine& subroutine)
    {
        ...
        _get_indices()[std::size_t(uniform.Location())] = GLuint(subroutine.Location());
    ...
    private:
        ...
        Preset(
            ...
            ShaderType stage,
#endif
            const std::vector<GLuint>& indices) : _indices(indices)
#ifndef NDEBUG
                                                  ,
                                                  _program(program), _stage(stage)
#endif
        {
        }
...
#ifndef NDEBUG
              ,
              _program(tmp._program), _stage(tmp._stage)
#endif
        {
        }
    };
