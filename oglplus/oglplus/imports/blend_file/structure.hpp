...
private:
    ...
    BlendFileStructField(
        ...
        std::size_t field_index) : _sdna(sdna), _struct_index(struct_index), _field_index(field_index)
    {
        assert(_sdna);
    }
...
private:
    ...
    BlendFileStructFieldRange(
        BlendFileSDNA* sdna,
        std::size_t struct_index) : Base(_field_count(sdna, struct_index)), _sdna(sdna), _struct_index(struct_index)
    {
    }
...
private:
    ...
    BlendFileStruct(
        BlendFileSDNA* sdna,
        std::size_t struct_index) : BlendFileType(sdna,
...
private:
    ...
    BlendFileStructRange(BlendFileSDNA* sdna)
        : Base(sdna->_structs.size()), _sdna(sdna)
    {
    }
