...
private:
    ...
    BlendFileFlattenedStructField(
        ...
        const BlendFileSDNA::_flat_struct_info* flat_fields) : _sdna(sdna), _struct_index(struct_index), _flat_field_index(flat_field_index), _flat_fields(flat_fields)
    {
    }
...
private:
    ...
    BlendFileFlattenedStructFieldRange(
        BlendFileSDNA* sdna,
        std::size_t struct_index,
        const BlendFileSDNA::_flat_struct_info* flat_fields) : Base(_field_count(flat_fields)), _sdna(sdna), _struct_index(struct_index), _flat_fields(flat_fields)
    {
    }
