...
#define OGLPLUS_AUX_VARPARA_FNC(NAME, SUFFIX, SELECTOR, TYPE, NPARAM)                                    \
    static inline std::decay<                                                                            \
        decltype(::gl##NAME##SUFFIX)>::type _fns_##SELECTOR(std::integral_constant<std::size_t, NPARAM>, \
        const TYPE*, ...)                                                                                \
    {                                                                                                    \
...
#define OGLPLUS_AUX_VARPARA_MAT_FNC(NAME, SUFFIX, SELECTOR, TYPE, C, R, CxR)                             \
    static inline std::decay<                                                                            \
        decltype(::gl##NAME##CxR##SUFFIX)>::type _fns_##SELECTOR(std::integral_constant<std::size_t, C>, \
