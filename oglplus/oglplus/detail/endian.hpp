...
public:
    EndianHelper(void)
    {
        ...
        assert(
            (IsLittle() && !IsBig()) || (!IsLittle() && IsBig()));
    }

    bool IsBig(void) const
    {
        return (_hlp.y[0] == 0x12) && (_hlp.y[1] == 0x34) && (_hlp.y[2] == 0x56) && (_hlp.y[3] == 0x78);
    }

    bool IsLittle(void) const
    {
        return (_hlp.y[3] == 0x12) && (_hlp.y[2] == 0x34) && (_hlp.y[1] == 0x56) && (_hlp.y[0] == 0x78);
    }
};
