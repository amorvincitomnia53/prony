...
class ProgVarGetSetOps<OpsTag, tag::Uniform, T>
    : public ProgVarCommonOps<tag::Uniform>, public ProgVarBaseSetOps<OpsTag, tag::Uniform, tag::NativeTypes, T, 16>
{
protected:
...
class ProgVarGetSetOps<OpsTag, tag::Uniform, Vector<T, N>>
    : public ProgVarCommonOps<tag::Uniform>, public ProgVarBaseSetOps<OpsTag, tag::Uniform, tag::NativeTypes, T, 4>
{
protected:
    ProgVarGetSetOps(UniformLoc uloc)
        : ProgVarCommonOps<tag::Uniform>(uloc)
...
class ProgVarGetSetOps<OpsTag, tag::Uniform, Matrix<T, R, C>>
    : public ProgVarCommonOps<tag::Uniform>, public ProgVarBaseSetOps<OpsTag, tag::Uniform, tag::MatrixTypes, T, 16>
{
protected:
    ProgVarGetSetOps(UniformLoc uloc)
        : ProgVarCommonOps<tag::Uniform>(uloc)
