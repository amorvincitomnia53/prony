...
public:
        ...
        BufferName buffer)
    {
        ...
        OGLPLUS_VERIFY(
            BindBuffer,
            ObjectError,
            Object(buffer).BindTarget(target));
    }
...
class ObjCommonOps<tag::Buffer>
    : public BufferName, public ObjBindingOps<tag::Buffer>
{
protected:
...
public:
    ...
    {
        OGLPLUS_GLFUNC(InvalidateBufferData)
        (_obj_name());
        OGLPLUS_CHECK(
...
public:
        ...
        BufferUsage usage = BufferUsage::StaticDraw)
    {
        ...
        OGLPLUS_CHECK(
            BufferData,
            ObjectError,
            ObjectBinding(target).EnumParam(usage));
    }
    ...
    {
        OGLPLUS_GLFUNC(MakeBufferNonResidentNV)
        (GLenum(target));
        OGLPLUS_CHECK(
