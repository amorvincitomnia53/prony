...
public:
    ...
    Vector<GLfloat, 4> BorderColor(
        TypeTag<GLfloat> _auto_param_2) const
    {
    ...
    Vector<GLint, 4> BorderColor(
        TypeTag<GLint> _auto_param_2) const
    {
        return ExplicitOps::BorderColor(
            this->target,
            _auto_param_2);
    ...
    Vector<GLuint, 4> BorderColor(
        TypeTag<GLuint> _auto_param_2) const
    {
        return ExplicitOps::BorderColor(
            this->target,
            _auto_param_2);
    ...
    TextureSwizzle Swizzle(
        TextureSwizzleCoord coord) const
    {
	 ...
	 */
    const BoundObjOps& SwizzleRGBA(
        const TextureSwizzleTuple& modes) const
    {
        ExplicitOps::SwizzleRGBA(
            this->target,
            modes);
