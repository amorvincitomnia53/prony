...
class ProgVarGetSetOps<OpsTag, tag::VertexAttrib, T>
    : public ProgVarCommonOps<tag::VertexAttrib>, public ProgVarBaseSetOps<OpsTag, tag::VertexAttrib, tag::NativeTypes, T, 16>
{
protected:
...
class ProgVarGetSetOps<OpsTag, tag::VertexAttrib, Vector<T, N>>
    : public ProgVarCommonOps<tag::VertexAttrib>, public ProgVarBaseSetOps<OpsTag, tag::VertexAttrib, tag::NativeTypes, T, 4>
{
protected:
    ProgVarGetSetOps(VertexAttribLoc valoc)
        : ProgVarCommonOps<tag::VertexAttrib>(valoc)
...
public:
        ...
        const void* pointer) const
    {
        ...
        OGLPLUS_CHECK(
            VertexAttribPointer,
            Error,
            EnumParam(data_type).Index(_location));
        return *this;
    }
    ...
    const VertexArrayAttrib& LPointer(
        ...
        const void*) const
    {
        assert(!"The glVertexAttribLPointer function is "
    ...
    {
        OGLPLUS_GLFUNC(EnableVertexAttribArray)
        (_attrib_index());
        OGLPLUS_VERIFY(
    ...
    {
        OGLPLUS_GLFUNC(DisableVertexAttribArray)
        (_attrib_index());
        OGLPLUS_VERIFY(
