...
public:
    ...
    Plane(
        ...
        const Vector<T, 3>& p0,
        const Vector<T, 3>& p1,
        const Vector<T, 3>& p2) : _equation(Normalized(Cross(p1 - p0, p2 - p0)),
    ...
    Plane(
        ...
        const Vector<T, 3>& p,
        const Vector<T, 3>& v1,
        const Vector<T, 3>& v2) : _equation(Normalized(Cross(v1, v2)),
    ...
    Plane(
        ...
        const Vector<T, 3>& normal) : _equation(normal, -Dot(normal, point))
    {
    }
