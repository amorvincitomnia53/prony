...
private:
    ...
    static P _bi(
        ...
        P t)
    {
        return Binomial<M, I>::value * Pow<P>(t, std::integral_constant<unsigned, I>()) * Pow<P>(P(1) - t, std::integral_constant<unsigned, M - I>());
    }
...
private:
    ...
    static T _part(
        ...
        P t)
    {
        return Binomial<N, I>::value * Pow<P>(t, std::integral_constant<unsigned, I>()) * Pow<P>(P(1) - t, std::integral_constant<unsigned, N - I>()) * v[I] * w[I];
    }
    ...
    {
        return Binomial<N, I>::value * Pow<P>(t, std::integral_constant<unsigned, I>()) * Pow<P>(P(1) - t, std::integral_constant<unsigned, N - I>()) * w[I];
    }
