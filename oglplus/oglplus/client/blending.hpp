...
private:
    ...
    static void _do_set(context::BlendEquationSeparate value, DrawBufferIndex index)
    {
        if (GLuint(index) == 0) {
            if (value.Separate()) {
...
private:
    ...
    static void _do_set(context::BlendFunctionSeparate value, DrawBufferIndex index)
    {
        if (GLuint(index) == 0) {
            if (value.Separate()) {
